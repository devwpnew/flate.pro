        ...
        <>
            {!isLoading && !products && (
                <div className="my-5 w-full">
					...
					<div className="md:max-w-[300px] text-center md:text-left">

						{/* <div className="hidden md:flex rounded-[10px] bg-greyF3 h-[180px] w-full">
                            <div className="m-auto text-backdrop/20">
                                <MdOutlineImageNotSupported className="text-4xl" />
                            </div>
						</div> */}

						<div className="my-2">
							{title ? title : "У вас пока нет объявлений"}
						</div>

						{!hideButton && (
							<UserAddButton
								button
								buttonText={"Разместить"}
								icon={null}
							/>
						)}
                    ...
                    <div className="text-base font-bold text-center">
                        {title ? title : "У вас нет объявлений"}
                    </div>

                    {!hideButton && (
                        <div className="h-10 max-w-[255px]">
                            <UserAddButton
                                button
