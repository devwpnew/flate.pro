...
import ProductsContainerWithFetch from "@modules/posts/type/product/components/template/productsContainerWithFetch";
...
export default function favoritesContent({
    ...
    return (
        <MotionContainer>
            {MOBILE && (
                <MobilePageHeader href={"/user/profile"} title="Избранное" />
            )}

            <div className="flex flex-col gap-1 sm:container mx-auto px-[15px] lg:px-0">
                <ProductsContainerWithFetch
