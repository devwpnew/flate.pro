...
export default function FilterParkings({
  isSidebar,
  productsSum,
  sectionId,
  mortgageCallback,
  ...
  useEffect(() => {
    (async function fetchFields() {
      const options = await API.get.fieldInfo("product", "parking_types");
                ...
                >
                  ...
                  {houseTypes && (
                    <SelectMultiSelect
                      ...
                      style={"h-12"}
                      callback={parkingTypesCallback}
                      defaultValue={
                        filterGlobalFields.parking_types
                          ? filterGlobalFields.parking_types
                          : ""
                      }
                    />
