    ...
    <MotionContainer>
      <div className="relative">
        ...
        <div className="container mx-auto relative">
          ...
          <>
            <Container>
              <div className="flex justify-between flex-wrap gap-2.5 items-center pt-3 pb-2.5 lg:border-b-[1px] lg:border-greyborder">
                ...
                {isStartFilter && <ProductsSortSelect callback={setSort} />}
              </div>
            </Container>
          </>
          {/* )} */}
          ...
          <div className="lg:container lg:mx-auto lg:px-[15px]">
            <div className="lg:flex lg:items-start lg:gap-2.5 lg:mt-5 py-2.5">
              <CategoryOutput
                isRow={isRowTemplate}
                rcId={rcId}
                ...
                setProductsAmountLoadingCallback={setProductsAmountLoading}
