            ...
            >
                <div className="flex flex-col items-start">
					...
					<Link href={"/user/profile/subscribe"}>
                        <span className="inline-block text-blue hover:text-bluedeep text-sm cursor-pointer whitespace-nowrap group mb-[15px]">
                            <span className="relative">Сделать премиум</span>
                        </span>
                    </Link>
                    ...
                    <Dialog.Panel className="bg-white p-5 max-w-[500px] w-full rounded-[10px]">
                        {isLoading ? (
                            ...
                            <DialogMessage
                                ...
                                onCloseText={
                                    publishedStatus === 2 ? "Нет" : "Оставить"
                                }
