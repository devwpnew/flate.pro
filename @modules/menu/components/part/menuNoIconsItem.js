...
export default function MenuNoIconsItem({ name, id, slug, href, featured }) {
    ...
    const itemClassName = `group list-none py-[5px] px-[8px] rounded-[4px] cursor-pointer transition-all ${
        featured ? " bg-bluefeatured" : ""
    } hover:bg-blue/10 active:text-blue active:bg-bluefocus`;
