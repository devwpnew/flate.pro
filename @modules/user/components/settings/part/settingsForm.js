...
export default function SettingsForm({
  ...
  const sendPhoneConfirmation = async () => {
    if (typeof userNewPhone == "undefined" || userNewPhone.value.length < 20) {
      console.log("phone обязательный");
    } else {
      const smsAxios = await axios.post(
  ...
  return (
    <div className="flex flex-col gap-1 sm:container mx-auto px-[15px] lg:px-0">
      ...
      >
        ...
        <div
          className={`relative mb-4 ${blockClassName ? blockClassName : ""}`}
        >
          <Input
            topTitle={
              <div
          ...
          <Tooltip
            text={"Если вы работаете на себя, укажите “Частный брокер”"}
        ...
        >
          ...
          <Tooltip
            text={"Мы будем присылать вам только важные уведомления"}
          ...
          {emailError && (
            <div className="text-xs text-red pl-[3px]">{emailError}</div>
          )}
          {emailSent == true && (
            <div className="text-xs text-blue pl-[3px]">Отправлено</div>
          )}
        </div>
        <div className={`mb-4 ${blockClassName ? blockClassName : ""}`}>
          <Textarea
        ...
        {!router.asPath === "/user/profile/settings" && (
          <div className={`mb-10 ${blockClassName ? blockClassName : ""}`}>
        ...
        <div className="flex items-end justify-end col-span-2">
          <Button className={"p-2.5 w-auto h-auto"}>Сохранить изменения</Button>
        </div>
      </form>
            ...
            >
              ...
              <div className="flex flex-col	 items-center flex-wrap">
                <div className="mb-5 text-center">
                  {phoneStep == 1 && "Введите новый номер телефона"}
                  {phoneStep == 2 && (
                    <>
                ...
                {phoneStep == 1 && ( // Первый шаг
                  <>
                    <MaskInput
                      ...
                      maskChar="_"
                      defaultValue={
                        userNewPhone.value ? userNewPhone.value : false
                      }
              ...
              <button
                onClick={() => setPhoneConfirmationOpen(!phoneConfirmationOpen)}
        ...
        <DialogWrapper>
          <Dialog.Panel className="bg-white p-5 max-w-[400px] rounded-[10px] mx-[16px]">
            <DialogMessage
              ...
              subtitle={error ? error : "Настройки профиля успешно изменены"}
            />
          </Dialog.Panel>
        </DialogWrapper>
      </Dialog>
