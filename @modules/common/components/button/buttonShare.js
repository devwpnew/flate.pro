  ...
  return (
    <OutsideAlerter action={() => setShowCopyInput(false)}>
      <div className="relative">
        <ButtonWithIcon
          className={className ? className : "whitespace-nowrap py-1 px-2"}
          icon={<Icon />}
          iconW={iconW}
          iconH={iconH}
        ...
        {copyInput && (
          <div
            ...
            } top-8 z-20 bg-greyF3 p-[5px] rounded flex items-center`}
            ref={containerRef}
          ...
          >
            <div
              ...
              style={{ color: "#777777" }}
            >
              {shareButtonLink ? shareButtonLink : window.location.href}
            </div>
            <Button className={"w-auto px-2.5 py-1"} onClick={handleCopyClick}>
              Копировать
            </Button>
          </div>
        )}
